...
class AndreMoraesAdaptedStrategy(AndreMoraesStrategy):
    ...
    def _check_business_rules(self, business_data, tcks_priority, tck_idx):
        ...
        max_peak_1 = round(tcks_priority[tck_idx].extra_vars["last_max_peaks"][0] / tcks_priority[tck_idx].last_business_data["close_price_day"], 4)
        max_peak_2 = round(tcks_priority[tck_idx].extra_vars["last_max_peaks"][1] / tcks_priority[tck_idx].last_business_data["close_price_day"], 4)
        min_peak_1 = round(tcks_priority[tck_idx].extra_vars["last_min_peaks"][0] / tcks_priority[tck_idx].last_business_data["close_price_day"], 4)
        min_peak_2 = round(tcks_priority[tck_idx].extra_vars["last_min_peaks"][1] / tcks_priority[tck_idx].last_business_data["close_price_day"], 4)

        ema_17_day = round(tcks_priority[tck_idx].last_business_data["ema_17_day"] / tcks_priority[tck_idx].last_business_data["close_price_day"], 4)
        ema_72_day = round(tcks_priority[tck_idx].last_business_data["ema_72_day"] / tcks_priority[tck_idx].last_business_data["close_price_day"], 4)
        ema_72_week = round(tcks_priority[tck_idx].last_business_data["ema_72_week"] / tcks_priority[tck_idx].last_business_data["close_price_day"], 4)
        stop_loss_feat = round(tcks_priority[tck_idx].last_business_data["stop_loss_day"] / tcks_priority[tck_idx].last_business_data["close_price_day"], 4)
