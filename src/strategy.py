...
class AdaptedAndreMoraesStrategy(PseudoStrategy):
    ...
    def __init__(self, tickers, alias=None, comment=None, risk_capital_product=0.10,
        ...
        if operation_risk < 0.0 or operation_risk > 1.0:
            logger.error(f"Parameter \'operation_risk\' must be in the interval [0.0, 1.0].")
            # sys.exit(c.INVALID_ARGUMENT_ERR)
            raise Exception
        ...
        self._db_strategy_model = DBStrategyModel(self._name, only_tickers, self._initial_dates,
            ...
            dynamic_rcc_k=self._dynamic_rcc_k, operation_risk=self._operation_risk,
            profit_comp_start_std=self._profit_comp_start_std,
            profit_comp_end_std=self._profit_comp_end_std,
            profit_comp_gain_loss=self._profit_comp_gain_loss)
...
class MLDerivationStrategy(AdaptedAndreMoraesStrategy):
    ...
    def __init__(self, tickers, alias=None, comment=None, risk_capital_product=0.10,
        ...
        profit_comp_start_std=0.2, profit_comp_end_std=2.0, profit_comp_gain_loss=0.6):
        ...
        super().__init__(tickers, alias, comment, risk_capital_product, total_capital,
            ...
            profit_comp_end_std, profit_comp_gain_loss)
    ...
    def _get_risk(self, ticker, day, force=False):
        ...
        risk = min_risk + (max_risk - min_risk) * self.operation_risk
    ...
    def _calc_profit_compensation(self, target_profit, profit_mean, profit_std):
        ...
        end_std = self.profit_comp_end_std
